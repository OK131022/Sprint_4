...
public class CheckAnswerTest extends RulelTest {

    private final By QUESTION;
    private final By ANSWER;
    private final String EXPECTED;

    //Конструктор с параметрами вопроса, ответа и ожидаемого результата
    public CheckAnswerTest(By QUESTION, By ANSWER, String EXPECTED) {
        this.QUESTION = QUESTION;
        this.ANSWER = ANSWER;
        this.EXPECTED = EXPECTED;
    }

    @Parameterized.Parameters(name = "Ожидаем: {2}")
    ...
    //Проверка ответов в выпадающем списке в разделе «Вопросы о важном»
    // создание объекта класса домашней страницы
    // открыть страницу, убрать куки
    // подождать загрузки страницы
    // проскролить до списка вопросов
    // вызов метода, который нажимает на вопрос
    // страснение ожидаемого текста и полученного в результате теста
